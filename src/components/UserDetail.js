...
const UserDetail = ({apiData}) => {
    ...
    details.push(["STATUS", detail.status])
                ...
                <div style={{width: "100%", flex: "4 0 1px", margin: '3rem'}}>
                    <div style={{display: 'flex', flexDirection: "column", width: "100%", height: "100%"}}>
                        <div style={{flex: '0.125 0 1rem', display: "flex"}}>
                            <Button style={{margin: '0.37rem 0.5rem 0.37rem 0.5rem',}}variant="secondary" as={Link} to={`/`}>Back to Home</Button>
                        </div>
                                ...
                                <Card.Body style={{padding: "0"}}>
                                    <div style={{display: "flex", width: "100%", height: "100%"}}>
                                        <div style={{width: "100%", flex: "1 0 1rem", textAlign: "center", overflow: "hidden"}}>
                                            <img src={detail.image.medium} style={{width: "100%"}}/>
                                        </div>
